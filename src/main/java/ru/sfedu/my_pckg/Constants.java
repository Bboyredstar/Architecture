...
public class Constants {
  ...
  public static final String CURRENT_EXTENSION = "Current files extension: ";
  ...
  public static final String LIST_RETURNED = "List was returned! ";
  ...
  public static final String EMPTY_NAME = "Empty name error! ";
